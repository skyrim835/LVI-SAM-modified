...
public:
    ...
    bool cachePointCloud(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg)
    {
        ...
        //std::cout<<"the size before:"<<laserCloudIn->points.size()<<std::endl;
        
        remove(*laserCloudIn,*laserCloudIn,indices);
        //std::cout<<"the size after:"<<laserCloudIn->points.size()<<std::endl;
    ...
    void projectPointCloud()
    {
        ...
        for (int i = 0; i < cloudSize; ++i)
        {
            ...
            //int rowIdn = (verticalAngle + 16.5) / (26 / float(32-1));
            int rowIdn = (verticalAngle + 16.5)/(ang_y);
